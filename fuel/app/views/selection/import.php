<section class="container">
	<h1 class="page-header">Import de selection</h1>
	...
	<div class="alert alert-info alert-dismissible" role="alert">
		...
		Il doit contenir une colonne "Nom", une colonne "Logo", et une colonne "Pays" contenant respectivement le nom de la selection sans caractères accentués, l'url des logo et le nom du pays associé à cette selection.
	</div>

	<section class="form">
		<form action="/selection/import" method="post" class="form-horizontal" enctype="multipart/form-data">
