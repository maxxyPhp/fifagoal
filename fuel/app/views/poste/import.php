<section class="container">
	<h1 class="page-header">Import de poste</h1>
	...
	<div class="alert alert-info alert-dismissible" role="alert">
		...
		Il doit contenir une colonne "Nom" contenant le nom du poste sans caractères accentués.
	</div>

	<section class="form">
		<form action="/poste/import" method="post" class="form-horizontal" enctype="multipart/form-data">
