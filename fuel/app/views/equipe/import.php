<section class="container">
	<h1 class="page-header">Import d'équipes</h1>
	...
	<div class="alert alert-info alert-dismissible" role="alert">
		...
		Il doit contenir une colonne "Nom", une colonne "Logo", et une colonne "Championnat" contenant respectivement le nom de l'équipe sans caractères accentués, l'url des logo et le nom du championnat associé à cette équipe.
	</div>

	<section class="form">
		<form action="/equipe/import" method="post" class="form-horizontal" enctype="multipart/form-data">
